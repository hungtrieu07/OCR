...
def init_args():
    ...
    parser.add_argument("--det_model_dir", type=str, default='infer_model/ch_PP-OCRv4_det_infer')
    ...
    parser.add_argument("--rec_model_dir", type=str, default='infer_model/ch_PP-OCRv4_rec_infer')
